...
SW_Type_t SW[NUM_OF_SW] = {
		{SW_PORTC, LED_PIN0, SW_Int_PULL_UP},
		{SW_PORTC, LED_PIN1, SW_Int_PULL_UP},
		{SW_PORTC, LED_PIN2, SW_Int_PULL_UP},
		{SW_PORTC, LED_PIN3, SW_Int_PULL_UP},
		{SW_PORTC, LED_PIN4, SW_Int_PULL_UP},
		{SW_PORTC, LED_PIN5, SW_Int_PULL_UP},
		{SW_PORTC, LED_PIN6, SW_Int_PULL_UP},
		{SW_PORTC, LED_PIN7, SW_Int_PULL_UP}
};
